...
func TestAuthoringCapabilityMatrix(t *testing.T) {
	capabilities := []Capability{CapabilityRead, CapabilityDraftEdit, CapabilityStructureEdit, CapabilityContentEdit, CapabilityMembersManage, CapabilityDraftAbandon, CapabilityReviewRead, CapabilityReviewSubmit, CapabilityReviewDecide, CapabilityPublish}
	for _, tc := range []struct {
		role    MemberRole
		allowed []bool
	}{
		{MemberAuthor, []bool{true, true, true, true, false, false, true, true, false, false}},
		{MemberMaintainer, []bool{true, true, true, true, true, true, true, true, true, true}},
	} {
	...
	if roleAllows(MemberRole("ADMINISTRATOR"), CapabilityPublish) || roleAllows(MemberMaintainer, Capability("unknown")) {
